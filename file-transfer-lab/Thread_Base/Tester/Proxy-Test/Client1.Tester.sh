...
cd ./../../client/
./Client.py -p -lf file.txt  -rf file10.txt
./Client.py -p -lf file2.txt -rf file11.txt 
./Client.py -p -lf file3.txt -rf file12.txt
./Client.py -p -lf file4.txt -rf file13.txt
./Client.py -p -lf file5.txt -rf file14.txt
./Client.py -p -lf file6.txt -rf file15.txt
